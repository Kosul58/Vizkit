...
'01a066fa-6ff7-7eb9-9ef2-b9e9598db643',
    ...
    $$,
'{"helperText": "See the total amount you have refunded for the selected period, so you know how much money is going back out."}',
        'KPI',
        60,
    ...
    $$,
'{"helperText": "See what percentage of your gross sales value is being refunded, so you can track how much revenue you are losing to refunds."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL
           OR COALESCE(r.processed_at, r.created_at)::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how many distinct orders had at least one refund, so you can track how widespread refund activity is."}',
        'KPI',
        60,
    ...
    $$,
'{"helperText": "See what percentage of your orders ended up refunded, so you can track refund frequency relative to overall order volume."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL
           OR COALESCE(r.processed_at, r.created_at)::date <= :currentEndDate::date)
    $$,
'{"helperText": "See the average dollar amount per refund, so you can gauge the typical size of a refund."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL OR o.created_at::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how much you have refunded in shipping charges, so you can track shipping-related refund costs."}',
        'KPI',
        60,
    ...
    $$,
'{"helperText": "See the total value of successful refund transactions processed through your payment gateway, so you know how much has actually gone back to customers."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL OR o.created_at::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how much discount value is tied to refunded units, so you can understand the discount impact of your refunds."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL OR o.created_at::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how many orders were partially refunded, so you can track orders with only some items or amounts returned."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL OR o.created_at::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how many orders were fully refunded, so you can track complete order returns."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL OR o.created_at::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how many units were removed from orders due to refunds, so you can track return volume at the item level."}',
        'KPI',
        60,
    ...
    WHERE o.seller_id = :shopId
      ...
      AND (:currentEndDate::date   IS NULL OR o.created_at::date <= :currentEndDate::date)
    $$,
'{"helperText": "See how many units are still eligible for refund, so you can track your remaining refund exposure."}',
        'KPI',
        60,
...
INSERT INTO
    vizkit.chart_signal (id, chart_id, name, query)
VALUES (
